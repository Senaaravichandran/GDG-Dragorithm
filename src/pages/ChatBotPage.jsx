    ...
    >
      ...
      <div className="flex-1 flex flex-col lg:flex-row  gap-8">
        ...
        <div className="flex-1 flex flex-col items-center mt-3">
          ...
          {isDropdownOpen && cameras.length > 0 && (
            ...
            >
              ...
              <select
                className={`w-full p-3 rounded-lg ${inputClass} border ${"text-white"}`}
        ...
        <div className="flex-1 flex flex-col" style={{ marginTop: "198px" }}>
          <div
            className={`${cardClass} rounded-lg shadow-lg overflow-hidden border ${"text-white border-gray-700"} mx-4 lg:mx-0`}
          >
            <div
              className={`p-4 flex justify-between items-center ${"bg-gray-700"} border-b ${"text-white"}`}
            >
              <div className="flex items-center space-x-2">
            ...
            <div className="relative" style={{ height: "400px" }}>
              {selectedCamera ? (
                ...
                <div className="flex flex-col items-center justify-center h-full bg-gray-800">
                  <FaVideoSlash size={64} className="text-white" />
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  className={`border-2 border-dashed ${"text-white"} rounded-lg p-4 text-center`}
                >
                  <input
                    type="file"
                    accept="video/*"
                  ...
                  <label htmlFor="videoFileInput" className="cursor-pointer">
                    <div className="flex flex-col items-center">
                      <Video size={36} className={`mb-2 ${"text-white"}`} />
        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="bg-green-900 text-green-300 text-xs font-medium px-2.5 py-0.5 rounded-full">
                Online
              </div>
